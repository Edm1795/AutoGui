...
class ScreenShot:
    '''
            ...
            Update self.path (in the desired position and computer (in the init) if you want to change the file's save location. This pause is built into my pressKeys() method.
