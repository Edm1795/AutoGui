...
def clickDate():
    ...
    day = weekdayConver(curDate)  # extract the weekday from the current date object as an int 0-6 for Mon-Sat. This is done with a helper func.
    print(day)
    print(week())
    yDiff = 37  # number of pixels between adjacent rows (eg week 1 - week 2) (work 32, home 37)
    xDiff = 44  # number of pixels between immediately adjacent days of week (eg:mon-tues) (work 36, home 44)
    xDefault = 857  # 36 pixel difference (home com 857, work 851)
    yDefault = 381  # (home com 381, work 301)
